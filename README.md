...
```
Inserte el tamaño y los números (0,0 para terminar)> 11,11
Entrada inválida
Inserte el tamaño y los números (0,0 para terminar)> 1,0123456789
 -       -   -       -   -   -   -   -
| |   |   |   | | | |   |     | | | | |
         -   -   -   -   -       -   -
| |   | |     |   |   | | |   | | |   |
...
- Versión de Node utilizada: `v8.11.1`